...
const TEXT = {
  "zh-CN": {
    ...
    pet: "宠物",
    importPet: "导入宠物…",
    importPetDialogTitle: "选择宠物资源文件夹",
    importPetButton: "导入",
    importPetFailed: "导入宠物失败",
    appearance: "外观",
    size: "尺寸",
    small: "小",
    medium: "中",
  ...
  "en-US": {
    ...
    importPetDialogTitle: "Choose Pet Resource Folder",
    importPetButton: "Import",
    importPetFailed: "Pet Import Failed",
